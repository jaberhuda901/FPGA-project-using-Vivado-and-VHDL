...
HD_PWD='C:/Users/jaberulhuda/Desktop/SYSC_3320_LAB_1/LogicGates/LogicGates.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_LogicGates.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_LogicGates.tcl
