...
HD_PWD='C:/Users/jaberulhuda/Desktop/SYSC_3320_LAB_1/LogicGates/LogicGates.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_LogicGates.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Top_LogicGates.tcl -notrace
